...
> **⚠ NOTA DE SYNC PARA MARKETING (pendente — próxima sessão de `roosterlabs-marketing`):** a T9 e (em menor grau) a T8 **divergem das fontes da verdade** e o código está na frente delas. Sem atualizar os arquivos abaixo, a próxima sincronização "corrige" essas mudanças de volta e o guardrail vira letra morta:
